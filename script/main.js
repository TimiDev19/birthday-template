...
const animationTimeline = () => {
  ...
  tl
    ...
    .from(".one", 2.5, { opacity: 0, y: 10 })
    .from(".two", 1.5, { opacity: 0, y: 10 })
    .to(".one", 1.4, { opacity: 0, y: 10 }, "+=2.5")
    .to(".two", 1.4, { opacity: 0, y: 10 }, "-=1")
    .from(".three", 2.0, { opacity: 0, y: 10 })
    .to(".three", 2.0, { opacity: 0, y: 10 }, "+=2")
    ...
    .to(".idea-1", 1.4, ideaTextTransLeave, "+=3") // doubled delay
    ...
    .to(".idea-5 span", 1.4, { rotation: 90, x: 8 }, "+=0.8")
